...
function Highlights({ data, uvIndex, chanceOfRain }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 mt-4">
      {/* Humidity */}
      <div className="bg-white rounded-lg shadow-md p-3 text-center flex flex-col justify-center items-center h-24 w-full">
        <WiHumidity className="text-2xl mb-1 text-blue-400" />
      ...
      {/* Wind Speed */}
      <div className="bg-white rounded-lg shadow-md p-3 text-center flex flex-col justify-center items-center h-24 w-full">
        <WiStrongWind className="text-2xl mb-1 text-blue-400" />
      ...
      {/* UV Index */}
      <div className="bg-white rounded-lg shadow-md p-3 text-center flex flex-col justify-center items-center h-24 w-full">
        <WiDaySunny className="text-2xl mb-1 text-yellow-400" />
      ...
      {/* Chance of Rain */}
      <div className="bg-white rounded-lg shadow-md p-3 text-center flex flex-col justify-center items-center h-24 w-full">
        <WiRaindrop className="text-2xl mb-1 text-blue-400" />
